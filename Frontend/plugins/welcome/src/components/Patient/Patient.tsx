...
const Patient: FC<{}> = () => {
  ...
  function checkNull() {
    if (patient.Address === null || patient.Age === null || patient.Allergic === null || patient.Birthday === null || patient.Card_id === null || patient.First_name === null || patient.Gender === null || patient.Job == null || patient.Last_name === null || patient.Title === null) {
      Toast.fire({
        icon: 'warning',
